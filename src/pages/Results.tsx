...
const Results = () => {
  ...
  if (isGenerating) {
    ...
    const STAGE_LABELS: Record<string, string> = {
      ...
      generating_questions_2: "Generating questions (11–25)",
      generating_questions_3: "Generating questions (26–40)",
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="container-tight flex-1 py-8 md:py-10">
        ...
        <footer className="mt-16 border-t border-border pt-6 pb-2 text-xs text-muted-foreground space-y-1">
          ...
          <p><span className="text-foreground/80">{user?.email ?? "—"}</span></p>
          <p>{BRAND.fullName}</p>
          <p>For personal use only — not for resale or redistribution.</p>
        </footer>
      </main>
    </div>
  );
